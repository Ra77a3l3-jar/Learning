...
# SETUP COMMANDS
#==============================================================================
set xlabel 'Tempo (secondi)' enhanced textcolor '#404040'
set ylabel 'Carica batteria (Wh)' enhanced textcolor '#404040'
...
plot \
    ...
    'plot0.dat' index 1 title 'Livello batteria' with lines linestyle 2 linewidth 2
